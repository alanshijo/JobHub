      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="row mb-5">
              <div class="col-6">
                <button class="btn btn-block btn-light btn-md text-white"><i class="icon-heart mr-2"></i>Save Job</button>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                <li class="mb-2"><strong class="text-black">Published on:</strong> {{$job->updated_at}}</li>
                ...
                <li class="mb-2"><strong class="text-black">Experience:</strong> {{$job->expericence}}</li>
            ...
            <div class="bg-light p-3 border rounded">
              ...
              <div class="px-3">
                <a href="https://www.facebook.com/sharer/sharer.php?u={{route('single.job', $job->id)}}&quote={{$job->job_title}}" target="_blank" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
                <a href="https://twitter.com/intent/tweet?text={{$job->job_title}}&url={{route('single.job', $job->id)}}" target="_blank" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
                <a href="https://www.linkedin.com/sharing/share-offsite/?url={{route('single.job', $job->id)}}" target="_blank" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-linkedin"></span></a>
              </div>
            </div>
